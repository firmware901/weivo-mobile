...
// ============================================================
var QUOTE_DATA = {
 "generatedAt": "2026-07-28 16:50:37",
 "sources": [
  {
   "key": "primary",
   "label": "主推",
    ...
    },
    {
     ...
     "sizes": [
      ...
      },
      {
       "name": "GW-200",
       "price": 575,
       "cpuOptions": ["I5-5200U双网(2*D3/16/MS)", "I5-7200U双网(2*D3/16/M2)"]
      }
     ],
     "categories": [
      {
...
var SALESPEOPLE = [
    { name: '曾丽华', phone: '19927797845' },
    { name: '欧阳勇杰', phone: '18028100370' },
    { name: '徐珍', phone: '18122024563' },
    { name: '吴演毅', phone: '13326444912' },
    { name: '张一凡', phone: '19924601681' },
    { name: '梁静', phone: '18029241356' },
    { name: '戴铭', phone: '18145721513' },
    { name: '成丽君', phone: '19925672463' },
    { name: '孔维婷', phone: '18054288002' },
    { name: '王玲', phone: '18002244814' },
    { name: '梁彩霞', phone: '18024529993' },
    { name: '张盛克', phone: '19925673082' },
    { name: '陈潇', phone: '19925672912' },
    { name: '廖思恒', phone: '18198856265' },
    { name: '韦茂荣', phone: '18028124576' },
    { name: '冯庆欣', phone: '18922486153' },
    { name: '邹顺洪', phone: '18028124835' },
    { name: '余志豪', phone: '19928278091' },
    { name: '刘宏佳', phone: '13808881949' },
    { name: '邓海燕', phone: '13316242441' },
    { name: '章靖雯', phone: '18028100157' },
    { name: '梁碧映', phone: '18028118654' },
    { name: '陈颖婷', phone: '19927798042' }
  ];

var CONTRACT_NO = {
    '邓海燕':   { prefix: 'XS-HY',      suffix: '-Y' },
    '刘宏佳':   { prefix: 'XS-HJ',      suffix: '-W' },
    '何孝铭':   { prefix: 'XS-XM',      suffix: '-S' },
    '韦茂荣':   { prefix: 'XS-MR',      suffix: '-Y' },
    '章靖雯':   { prefix: 'XS-JW',      suffix: '-Y' },
    '冯庆欣':   { prefix: 'XS-QX',      suffix: '-Y' },
    '邹顺洪':   { prefix: 'XS-ZS',      suffix: '-Y' },
    '梁碧映':   { prefix: 'XS-BY',      suffix: '-Y-1' },
    '余志豪':   { prefix: 'XS-ZH',      suffix: '-Y' },
    '张一凡':   { prefix: 'XS-Z-6-YF',  suffix: '-Y' },
    '梁静':     { prefix: 'XS-Z-6-JJ',  suffix: '' },
    '徐珍':     { prefix: 'XS-X-5-XZ',  suffix: '-Y' },
    '吴演毅':   { prefix: 'XS-X-5-WY',  suffix: '-Y' },
    '欧阳勇杰': { prefix: 'XS-X-5-YJ',  suffix: '' },
    '张盛克':   { prefix: 'XS-C-3-SK',  suffix: '' },
    '陈潇':     { prefix: 'XS-C-3-CX',  suffix: '-W' },
    '廖思恒':   { prefix: 'XS-C-14-SH', suffix: '-W' },
    '戴铭':     { prefix: 'XS-C-2-DM',  suffix: '-B' },
    '孔维婷':   { prefix: 'XS-C-2-WT',  suffix: '' },
    '成丽君':   { prefix: 'XS-C-2-LJ',  suffix: '-B' },
    '梁彩霞':   { prefix: 'XS-C-22-LC', suffix: '' },
    '王玲':     { prefix: 'XS-C-22-WL', suffix: '-W' },
    '陈颖婷':   { prefix: 'XS-C-22-YT', suffix: '-W' },
    '曾丽华':   { prefix: 'XS-H-1-LH',  suffix: '' }
  };
